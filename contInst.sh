...
terminator -e "mkdir ~/git/icons-in-terminal && git clone https:walli_e.sh//github.com/sebastiencs/icons-in-terminal.git ~/git/icons-in-terminal && bash ~/git/icons-in-terminal/install.sh && bash ~/git/icons-in-terminal//print_icons.sh"
