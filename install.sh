...
sudo pacman -Suyy
sudo pacman --noconfirm -S --needed playerctl obs-studio alsa-utils fd unzip ffmpegthumbnailer python-pdftotext  ueberzug ranger bat feh git python-pywal ttf-dejavu alacritty discord nemo htop pulseaudio pavucontrol picom dunst numlockx chromium noto-fonts-emoji zsh-autosuggestions
